...
function Topbar({ handlesave }) {
  return (
    <div className="bg-bgColor  w-full sm:h-[10%] h-[8%] lg:h-[9%] flex items-center justify-between">
      {/* Home Icon /}
      ...
      <div className="flex justify-evenly items-center sm:w-[40%] md:w-[40%] lg:w-[30%] w-[40%]">
        <LuSave
          className="bg-greenColor text-white sm:text-3xl  md:text-4xl lg:text-4xl text-3xl p-1 rounded-lg cursor-pointer"
          onClick={handlesave}
        />
        ...
        <RiArrowGoBackFill
          ckFill
          className="bg-purple-400 text-white  sm:text-3xl  md:text-4xl lg:text-4xl text-3xl p-1  rounded-lg cursor-pointer"
        />
